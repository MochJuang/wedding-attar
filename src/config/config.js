...
const config = {
  data: {
    ...
    address: "Kampung Pasucen, RT. 02, RW. 04, Desa Sukagalih, Kecamatan Cikalong Kulon, Kabupaten Cianjur (Samping SDN 1 Cikalong Kulon)",
    ...
    audio: {
      src: "/audio/Wedding 050223 Aku memilihmu Brisia Jodie ft Fabio.mp3", // or /audio/nature-sound.mp3
